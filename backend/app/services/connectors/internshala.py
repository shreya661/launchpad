"""Internshala connector — CANNOT auto-submit (no public apply API, and
scripting a login risks the account). This connector prepares everything and
gives you a one-click URL to the internship/job or a search page."""
...
def apply(job: dict, master_resume: dict, portal_profile: dict) -> dict:
    ...
    if "internshala.com" in url:
        ...
        apply_url = f"https://internshala.com/internships/keywords-{query}"
    ...
    return {
        ...
        "apply_url": apply_url,
        "message": (
            "Internshala doesn't allow automated applications — your tailored resume "

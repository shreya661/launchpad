"""Naukri connector — CANNOT auto-submit (scripting Naukri logins risks
your account). This connector prepares everything and gives you a one-click
URL to the apply page."""
...
def apply(job: dict, master_resume: dict, portal_profile: dict) -> dict:
    ...
    if "naukri.com" in url:
        ...
        apply_url = f"https://www.naukri.com/jobid?q={query}"
    ...
    return {
        ...
        "apply_url": apply_url,
        "message": (
            "Naukri doesn't allow automated applications — your tailored resume "
